...
INSERT [Maintenance].[Customers] ([CustomerId], [FirstName], [LastName], [DateOfBirth], [CustomerCookie], [ContactDetail_Id]) VALUES (1, N'Julie', N'Lerman', CAST(0x00009CF100000000 AS DateTime), N'CustomerCookieABCDE', NULL)
INSERT [Maintenance].[Customers] ([CustomerId], [FirstName], [LastName], [DateOfBirth], [CustomerCookie], [ContactDetail_Id]) VALUES (2, N'Jason', N'Salmond', CAST(0x0000796500000000 AS DateTime), N'CustomerCookieXYZ', NULL)
